  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-zinc-400 mt-1">Sources are managed per workspace</p>
      </div>
      <div className="rounded-lg border border-zinc-800 bg-zinc-900 p-6 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500">
            Sources belong to a specific workspace. Go to{' '}
            <Link
            ...
            , open one, and manage its sources there.
          </p>
        </div>
      </div>
    </div>
